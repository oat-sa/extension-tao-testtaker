...
$GLOBALS['__l10n']["Edit subject"]="オブジェクト編集";
...
$GLOBALS['__l10n']["Test taker saved"]="受験者が保存されました";
$GLOBALS['__l10n']["Test takers"]="受験者";
$GLOBALS['__l10n']["Test takers library"]="受験者ライブラリ";
$GLOBALS['__l10n']["Test takers may be assigned to sets according to the relevant assessment context (Human resources management, education, edumetric monitoring, etc.)."]="受験者は関連する評価の文脈（人材管理・教育組織・教育測定上の監視単位など）に応じて，セットに割り当てられるかもしれません。";
...
$GLOBALS['__l10n']["The Test takers module allows to record and manage  test takers."]="受験者モジュールは受験者　の記録と管理を許可する。";
