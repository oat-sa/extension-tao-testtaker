...
$GLOBALS['__l10n']["Class saved"]="تم حفظ الصنف";
...
$GLOBALS['__l10n']["Edit subject"]="تحرير الموضوع";
$GLOBALS['__l10n']["Edit subject class"]="تعديل الصنف موضوع";
...
$GLOBALS['__l10n']["Its flexibility allows the design of datasheets (e.g. name, address, date of birth, gender etc.)."]="(مرونته تسمح بتصميم بنية البيانات (مثل الاسم والعنوان وتاريخ الميلاد، الجنس وغيرها";
...
$GLOBALS['__l10n']["Test takers may be assigned to sets according to the relevant assessment context (Human resources management, education, edumetric monitoring, etc.)."]="(قد يتم تعيين المتقدمين للاختبار إلى مجموعات وفقا لسياق التقييم ذات الصلة (إدارة الموارد البشرية، والتعليم، ورصد، الخ";
$GLOBALS['__l10n']["Tests"]="الاختبارات";
$GLOBALS['__l10n']["The format of this field is not valid."]="تنسيق هذا الحقل غير صالح";
$GLOBALS['__l10n']["The Test takers module allows to record and manage  test takers."]="وحدة المتقدمون للاختبار تسمح بتسجيل وإدارة المتقدمين للاختبار";
