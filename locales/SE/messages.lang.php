...
$GLOBALS['__l10n']["Edit subject"]="Redigera testtagare";
$GLOBALS['__l10n']["Edit subject class"]="Redigera testtagarklass";
...
$GLOBALS['__l10n']["Its flexibility allows the design of datasheets (e.g. name, address, date of birth, gender etc.)."]="Datan (ex. namn, adress, födelsedatum, kön etc.) kan designas flexibelt.";
...
$GLOBALS['__l10n']["Test takers may be assigned to sets according to the relevant assessment context (Human resources management, education, edumetric monitoring, etc.)."]="TEsttagare kan knytas till placeringar enligt det relevanta utvärderingssammanhanget (human resource management, utbildning etc.).";
$GLOBALS['__l10n']["Tests"]="Tester";
$GLOBALS['__l10n']["The format of this field is not valid."]="Formatet hos detta fält är ogiltigt";
$GLOBALS['__l10n']["The Test takers module allows to record and manage  test takers."]="Testtagarmodulen låter dig registrera och hantera testtagare";
