...
describe('Test Takers Page', () => {
    ...
    describe('Test Takers page', () => {
        it('should be Test Takers menu button', function () {
            cy.get('nav ul.main-menu li.active a span.icon-test-taker').should('have.length', 1);
        });

        it('should be left panel with test takers tree', function () {
            cy.get('div.taotree-test_taker').find('ul').children().should('not.to.have.length', 0);
        });
